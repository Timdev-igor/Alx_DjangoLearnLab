...
SECRET_KEY = 'django-insecure-sq8%0&zh18%6drh5*8_+=*=ns4acf-c$(sbsukxnu%7c(@1w11'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication', 
         'rest_framework.permissions.DjangoModelPermissions', # Session-based auth
    ],
}